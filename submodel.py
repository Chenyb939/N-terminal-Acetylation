...
def BetapropensityNetwork(trainX, trainY, valX, valY, physical_B_input, folds, train_time=None):
    ...
    if (train_time == 0):
        ...
        BetapropensityNetwork.compile(loss='binary_crossentropy', optimizer=optimization,
...
def CompositionNetwork(trainX, trainY, valX, valY, physical_C_input, folds, train_time=None):
    ...
    if (train_time == 0):
        ...
        CompositionNetwork.compile(loss='binary_crossentropy', optimizer=optimization,
                                   metrics=[keras.metrics.binary_accuracy])
...
def HydrophobicityNetwork(trainX, trainY, valX, valY, physical_H_input, folds, train_time=None):
    ...
    if (train_time == 0):
        ...
        optimization = 'Nadam'
        HydrophobicityNetwork.compile(loss='binary_crossentropy', optimizer=optimization,
                                      metrics=[keras.metrics.binary_accuracy])
    else:
...
def PhysicochemicalNetwork(trainX, trainY, valX, valY, physical_P_input, folds, train_time=None):
    ...
    if (train_time == 0):
        ...
        PhysicochemicalNetwork.compile(loss='binary_crossentropy', optimizer=optimization,
                                       metrics=[keras.metrics.binary_accuracy])
    else:
...
def OtherNetwork(trainX, trainY, valX, valY, physical_O_input, folds, train_time=None):
    ...
    if (train_time == 0):
        ...
        OtherNetwork.compile(loss='binary_crossentropy', optimizer=optimization,
                             metrics=[keras.metrics.binary_accuracy])
    else:
