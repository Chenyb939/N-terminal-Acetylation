...
def decode(allseq, label):
    ...
    for sequence in allseq:
        ...
        for AA in sequence:
            ...
            AANo += 1
        sampleNo += 1
    return probMatr, label


def phy_decode_H(allseq, label):
    '''
...
def phy_decode_all(allseq, label):
    label = np.array(label)
