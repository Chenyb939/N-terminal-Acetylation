...
def run_model(folds):
    # """test"""
    # sequence, label = check_data.get_data(os.path.join('/home/chenyb/PTM/data/uniport/test/fasta/first100', 'test.fa'))
    ...
    for t in range(0, iteration_times):
        ...
        """val"""
        sequence2, label2 = check_data.get_data(os.path.join('/home/chenyb/PTM/data/uniport/train/fasta/first100/val', str(folds), 'all.fa'))
        ...
        # del val_onehotX, val_onehotY, val_phyAX, val_phyAY, val_phyBX, val_phyBY, val_phyCX, val_phyCY, val_phyHX, val_phyHY, val_phyOX, val_phyOY, val_phyPX, val_phyPY

        sequence1, label1 = check_data.get_data(os.path.join('/home/chenyb/PTM/data/uniport/train/fasta/first100/train', str(folds), 'all.fa'))
        train_onehot_X, train_onehot_Y = check_data.decode(sequence1, label1)
