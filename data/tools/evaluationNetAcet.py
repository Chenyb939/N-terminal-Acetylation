...
#     likind = ["G", "S"]
def NetAcet_eva(likind):
    for kind in likind:
        file_fa = u"D:\\Users\\omen\\PycharmProjects\\N-terminal-Acetylation\\data\\uniport\\test\\fasta\\first3\\" + kind + ".fa"
        file_res=u"D:\\Users\\omen\\PycharmProjects\\N-terminal-Acetylation\\data\\uniport\\result\\NetAcet\\first3\\" + kind + ".txt"
        file_eva = "D:\\Users\\omen\\PycharmProjects\\N-terminal-Acetylation\\data\\uniport\\result\\NetAcet\\first3\\" \
                     + kind + "-evaluation.txt"
